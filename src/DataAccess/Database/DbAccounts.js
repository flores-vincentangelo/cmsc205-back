...
async function register(userModel) {
	let sql = "INSERT INTO accounts (email, password, first_name, last_name) VALUES (?, ?, ?, ?);";
	let inserts = [userModel.Email, userModel.HashedPassword, userModel.FirstName, userModel.LastName];
